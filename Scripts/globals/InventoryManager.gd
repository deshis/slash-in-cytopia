...
var starter_items: Array[ItemResource] = [
	load("res://Scripts/items/military/Katana.tres"),
	load("res://Scripts/items/military/AbsoluteZero.tres"),
	load("res://Scripts/items/consumer/MenderChip.tres"),
	load("res://Scripts/items/military/Shuriken.tres"),
	load("res://Scripts/items/prototype/OverclockedExoskeleton.tres"),
	]
